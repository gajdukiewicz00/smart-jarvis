package com.smartjarvis.gateway.infrastructure.config;
...
/**
 * Infrastructure configuration for Spring Cloud Gateway
 * 
 * This configuration handles infrastructure concerns like CORS, security,
 * and custom filters. It follows the Single Responsibility Principle.
 */
@Configuration
